...
export default function CallControls({
  ...
  return (
    <>
      ...
      <div
        className={`flex items-center justify-center gap-6 z-[60] backdrop-blur-xl bg-dark-900/70 rounded-full px-6 py-4 border border-white/10 shadow-2xl ${className}`}
